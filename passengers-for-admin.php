                        ...
                        if ($row['utype'] == "admin") {
                            ...
                            if ($result) {
                                ...
                                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                    echo '<tr><td style="padding: 5px; border: 1px solid black">' . $row['fname'] . '</td><td style="padding: 5px; border: 1px solid black">' . $row['lname'] . '</td><td style="padding: 5px; border: 1px solid black">' . $row['phone'] . '</td><td style="padding: 5px; border: 1px solid black">' . $row['current_location'] . '</td><td style="padding: 5px; border: 1px solid black">' . $row['destination'] . '</td><td style="padding: 5px; border: 1px solid black">' . $row['date'] . '</td></tr>';
                                }
